...
const Products = () => {
  ...
  const addProductApi = (productObj) => {
    ...
    axios.post(`${apiUrl}/api/products/create/${user._id}`, productObj, {
      ...
      showToast({ show: true, title: 'Success', message: 'Product Added Sucessfully', type: 'success' })
  ...
  const updateProductApi = (productObj) => {
    ...
    axios.put(`${apiUrl}/api/products/${productObj._id}/${user._id}`, productObj, {
      ...
      showToast({ show: true, title: 'Success', message: 'Product updated Sucessfully', type: 'success' })
  ...
  const deleteProductApi = (productObj) =>{
    setShowModal(false);
    let token = localStorage.getItem('token');
    console.log(productObj._id, user._id);
    axios.delete(`${apiUrl}/api/products/${productObj._id}/${user._id}`, {
      headers:{
        Authorization: `Bearer ${token}`
      }
    }).then(res => {
      showToast({ show: true, title: 'Success', message: 'Product Deleted Sucessfully', type: 'success' })
